...
public class MboxRequest extends RequestDetails {
    ...
    /**
     * An index for the mboxes to be executed or prefetched. Mbox index is used for correlation between the mbox
     * request with the mbox response, for either prefetch or execute responses. Index should be unique in the mbox
     * list.
     *
     * @return index
     **/
