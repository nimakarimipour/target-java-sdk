...
public class QAMode {
    ...
    /**
     * The encrypted token for the QA mode. It contains the list of the activity ids that are allowed to be executed
     * in QA mode. Validation   * After decryption, the client code from the token should match the one from the
     * request.   * After decryption, activities with the ids specified in the token should belong to the client.
     *
     * @return token
     **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(token, listedActivitiesOnly, evaluateAsTrueAudienceIds, evaluateAsFalseAudienceIds,
                previewIndexes);
    }
    ...
    public String toString() {
        ...
        sb.append("    listedActivitiesOnly: ").append(toIndentedString(listedActivitiesOnly)).append("\n");
        sb.append("    evaluateAsTrueAudienceIds: ").append(toIndentedString(evaluateAsTrueAudienceIds)).append("\n");
        sb.append("    evaluateAsFalseAudienceIds: ").append(toIndentedString(evaluateAsFalseAudienceIds)).append("\n");
