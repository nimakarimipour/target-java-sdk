...
public class MobilePlatform {
    ...
    /**
     * Optional field, added to help with device detection using device atlas. This is equivalent of a.DeviceName
     * field passed in from Mobile SDK
     *
     * @return deviceName
     **/
    ...
    /**
     * If not specified - all activities with any platformVersion will be evaluated. If specified - only activities
     * with the same platformVersion will be evaluated.
     *
     * @return version
     **/
